-- ==========================================================================
-- Skin "Charcoal" para MyCustomFrames.
-- Addon PROPIO (carpeta MyCustomFrames_Charcoal) -- pedido del usuario
...
-- ==========================================================================
local BASE = "Interface\\AddOns\\MyCustomFrames_Charcoal\\Assets\\"
...
-- usuario elige "Charcoal" en el dropdown de Skins.
if _G.MCF_RegisterSkin then
    _G.MCF_RegisterSkin("Charcoal", BASE, "Charcoal")
end
...
local function RegisterMasqueSkin()
    ...
    MSQ:AddSkin(SKIN_NAME, {
        ...
        Description = "Charcoal reskin, bundled with MyCustomFrames_Charcoal.",
        Version     = "1.0",
        Authors     = { "Gonkast" },
