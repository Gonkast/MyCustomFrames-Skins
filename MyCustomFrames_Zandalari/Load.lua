-- ==========================================================================
-- Skin "Zandalari" para MyCustomFrames.
-- Addon PROPIO (carpeta MyCustomFrames_Zandalari) -- pedido del usuario
...
-- ==========================================================================
local BASE = "Interface\\AddOns\\MyCustomFrames_Zandalari\\Assets\\"
...
-- usuario elige "Zandalari" en el dropdown de Skins.
if _G.MCF_RegisterSkin then
    _G.MCF_RegisterSkin("Zandalari", BASE, "Zandalari")
end
...
local function RegisterMasqueSkin()
    ...
    MSQ:AddSkin(SKIN_NAME, {
        ...
        Description = "Zandalari reskin, bundled with MyCustomFrames_Zandalari.",
        Version     = "1.0",
        Authors     = { "Gonkast" },
